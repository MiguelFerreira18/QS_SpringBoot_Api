...
class RespostaServiceTest
{
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,0,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1,1,1,5,2,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/,RespostaLabDesc0,0,0,4,1,26/12/2022,27/12/2022","20/12/202222222,RespostaLabDesC1,1,1,5,2,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,Desc0,0,0,4,1,26/12/2022,27/12/2022","20/12/2022,iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii,1,1,5,2,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,-1,0,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1,-99,1,5,2,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,-1,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1,1,999999,5,2,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,1,4,-1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1,1,1,5,99999,28/12/2022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,0,4,1,2022,27/12/2022","20/12/2022,RespostaLabDesC1,1,1,5,2,28  /  1 2/2 022,29/12/2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,0,4,1,26/12/2022,2022","20/12/202,RespostaLabDesC1,1,1,5,2,28/12/2022,29   / 12 /   2022"})
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0Update,0,0,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1Update,1,1,5,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa se e possivel dar update numa RespostaLaboratorio")
    @Order(23)
   void testUpdateRespostaLaboratorio(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim)throws ExecutionException,InterruptedException
   {
       RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
    ...
    @ParameterizedTest
    @CsvSource({"24/,RespostaLabDesc0Update,0,0,4,1,26/12/2022,27/12/2022","20/12/202222222,RespostaLabDesC1Update,1,1,5,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa a atualizao de uma RespostaLaboratorio com a data fora dos limites")
    @Order(24)
    void testUpdateRespostaLaboratorioDataOutOfBonds(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,updt0,0,0,4,1,26/12/2022,27/12/2022","20/12/2022,iiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii,1,1,5,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa a atualizacao de uma RespostaLaboratorio com a descricao fora dos limites")
    @Order(25)
    void testUpdateRespostaLaboratorioDescricaoOutOfBonds(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0Update,-1,0,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1Update,-99,1,5,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa a atualizacao de uma RespostaLaboratorio com o id da resposta fora dos limites")
    @Order(26)
    void testUpdateRespostaLaboratorioIdOutOfBonds(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0Update,0,-1,4,1,26/12/2022,27/12/2022","20/12/2022,RespostaLabDesC1Update,1,999999,5,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa a atualizacao de uma RespostaLaboratorio com o id do docente inexistente na base de dados")
    @Order(27)
    void testUpdateRespostaLaboratorioIdDocenteInexistent(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @Order(28)
    void testUpdateRespostaLaboratorioIdLabInexistent(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0Update,0,0,4,1,2022,27/12/2022","20/12/2022,RespostaLabDesC1Update,1,1,5,2,28  /  1 2/2 022,29/12/2022"})
    @DisplayName("Testa a atualizacao de uma RespostaLaboratorio com a data de reserva de inicio fora dos limites")
    @Order(29)
    void testUpdateRespostaLaboratorioReservaInicioOutOfBonds(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @Order(30)
    void testUpdateRespostaLaboratorioReservaFimOutOfBonds(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @ParameterizedTest
    @CsvSource({"24/12/2022,RespostaLabDesc0,0,0,-4,1,26/12/2022,27/12/2022","20/12/202,RespostaLabDesC1,1,1,99999,2,28/12/2022,29/12/2022"})
    @DisplayName("Testa a atualizacao de uma RespostaLaboratorio com o pedidoId inexistente")
    @Order(30)
    void testUpdateRespostaLaboratorioPedidoIdInexistent(String data, String descricao, int respostaId, int utilizadorId, int pedidoId,int laboratorioId, String dataReservaInicio, String dataReservaFim) throws ExecutionException, InterruptedException {
        RespostaLaboratorio r = new RespostaLaboratorio(data,descricao,respostaId,utilizadorId,pedidoId,laboratorioId,dataReservaInicio,dataReservaFim);
        String result = myService.updateRespostaLaboratorio(r);
        assertNull(result);
    }
    ...
    @ParameterizedTest
    @CsvSource({"24/12/22,RespostaMaterial0Update,2,30/12/22,31/12/22,1,0","01/01/23,RespostaMaterial1Update,3,02/01/23,04/01/23,2,1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial")
    @Order(31)
    void testUpdateRespostaMaterial(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @ParameterizedTest
    @CsvSource({"24/12,RespostaMaterial0Update,2,30/12/22,31/12/22,1,0","01  /  01  /  23,RespostaMaterial1Update,3,02/01/23,04/01/23,2,1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial com a data fora dos limites")
    @Order(32)
    void testUpdateRespostaMaterialDataOutOfBounds(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @Order(33)
    void testUpdateRespostaMaterialDescOutOfBounds(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @ParameterizedTest
    @CsvSource({"24/12/22,RespostaMaterial0Update,-1,30/12/22,31/12/22,1,0","01/01/23,RespostaMaterial1Update,-5,02/01/23,04/01/23,2,1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial com o id da resposta menor que zero")
    @Order(34)
    void testUpdateRespostaMaterialIdNegative(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @ParameterizedTest
    @CsvSource({"24/12/22,RespostaMaterial0Update,2,30/12,31/12/22,1,0","01/01/23,RespostaMaterial1Update,3,022 / 01111/2023,04/01/23,2,1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial com a dataReserva fora dos limites")
    @Order(35)
    void testUpdateRespostaMaterialReservaOutOfBounds(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @ParameterizedTest
    @CsvSource({"24/12/22,RespostaMaterial0Update,2,30/12/22,/12/22,1,0","01/01/23,RespostaMaterial1Update,3,02/01/23,042 / 011 / 2023,2,1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial com a dataEntrega fora do limite")
    @Order(36)
    void testUpdateRespostaMaterialEntregaOutOfBounds(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @Order(37)
    void testUpdateRespostaMaterialIdDocenteInexistent(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
    ...
    @Order(38)
    void testUpdateRespostaMaterialIdMateriaisInexistent(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(-1);
        materiaisId.add(-998);
    ...
    @ParameterizedTest
    @CsvSource({"24/12/22,RespostaMaterial0,2,30/12/22,31/12/22,1,9999","01/01/23,RespostaMaterial1,3,02/01/23,04/01/23,2,-1"})
    @DisplayName("Testa a atualizacao de uma RespostaMaterial com pedidoId inexistente ")
    @Order(38)
    void testUpdateRespostaMaterialPedidoIdInexistent(String data, String descricao, int respostaId, String dataReserva, String dataEntrega, int utilizadorId,int pedidoId) throws ExecutionException, InterruptedException {
        ArrayList <Integer> materiaisId = new ArrayList<>();
        materiaisId.add(1);
        materiaisId.add(2);
        materiaisId.add(3); //tem de ter obrigatoriamente pelo menos um destes materiais na base de dados
