...
public class RespostaLaboratorio extends Resposta{
    ...
    public RespostaLaboratorio(String data, String descricao, int respostaId, int utilizadorId,int pedidoId, int laboratorioId, String dataReservaInicio, String dataReservaFim, boolean aceite) {
